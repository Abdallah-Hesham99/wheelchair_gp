...
unsigned long long  ppr = 2000*295; 
double wheel_diameter=0.3;
double center_dist = 0.61;
double distance_per_tick = (M_PI*wheel_diameter)/ppr;
...
ros::Subscriber rsub = nd.subscribe("wheel_encoders/right_ticks",10,get_right_wheel_ticks);
ros::Subscriber lsub = nd.subscribe("wheel_encoders/left_ticks",10,get_left_wheel_ticks);
